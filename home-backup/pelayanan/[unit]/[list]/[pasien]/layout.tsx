      ...
      <div className="flex gap-4 mt-4">
        ...
        <div className="basis-3/4 h-full">
          <div className="rounded-2xl flex flex-row gap-2">
            <button
              onClick={() =>
                router.push(`/home/pelayanan/${unit}/${list}/${pasien}/asesmen`)
              }
              className={`text-accent font-semibold px-4 py-2 rounded-md shadow-md outline outline-2 outline-accent/30 ${
                pathname.includes("asesmen") && "bg-accent text-accent-content"
              }`}
            >
              Asesmen
            </button>
            <button
              onClick={() =>
                router.push(`/home/pelayanan/${unit}/${list}/${pasien}/cppt`)
              }
              className={`text-accent font-semibold px-4 py-2 rounded-md shadow-md outline outline-2 outline-accent/30 ${
                pathname.includes("cppt") && "bg-accent text-accent-content"
              }`}
            >
              CPPT
            </button>
            <button
              onClick={() =>
                router.push(
                  `/home/pelayanan/${unit}/${list}/${pasien}/tindakan`
                )
              }
              className={`text-accent font-semibold px-4 py-2 rounded-md shadow-md outline outline-2 outline-accent/30 ${
                pathname.includes("tindakan") && "bg-accent text-accent-content"
              }`}
            >
              Tindakan
            </button>
            <button
              onClick={() =>
                router.push(
                  `/home/pelayanan/${unit}/${list}/${pasien}/careplan`
                )
              }
              className={`text-accent font-semibold px-4 py-2 rounded-md shadow-md outline outline-2 outline-accent/30 ${
                pathname.includes("careplan") && "bg-accent text-accent-content"
              }`}
            >
              Care Plan
            </button>
            <button
              onClick={() =>
                router.push(`/home/pelayanan/${unit}/${list}/${pasien}/resume`)
              }
              className={`text-accent font-semibold px-4 py-2 rounded-md shadow-md outline outline-2 outline-accent/30 ${
                pathname.includes("resume") && "bg-accent text-accent-content"
              }`}
            >
              Resume
            </button>
            <button
              onClick={() =>
                router.push(`/home/pelayanan/${unit}/${list}/${pasien}/profil`)
              }
              className={`text-accent font-semibold px-4 py-2 rounded-md shadow-md outline outline-2 outline-accent/30 ${
                pathname.includes("profil") && "bg-accent text-accent-content"
              }`}
            >
              Profil
            </button>
